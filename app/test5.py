...
class FloatingWindow(QWidget):
    def __init__(self, original_text):
        ...
        self.resize(400, screen_geometry.height() // 2)  # Yatay sabit, dikey ekranın yarısı kadar
        self.move(screen_geometry.width() - 420, screen_geometry.height() - screen_geometry.height() // 2)
